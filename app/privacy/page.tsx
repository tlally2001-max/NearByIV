...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Privacy Policy | NearbyIV",
    description: "Learn how NearbyIV collects, uses, protects, and retains personal information.",
    url: "https://nearbyiv.com/privacy",
    type: "website",
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              NearbyIV ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li><strong>Location Data:</strong> Geographic information to help you find nearby IV therapy providers.</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Connecting you with IV therapy providers in your area</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">4. Disclosure of Your Information</h2>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li><strong>IV Therapy Providers:</strong> Relevant provider information to facilitate appointments and services.</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li><strong>Cookie Management:</strong> Adjust your browser settings to control cookie usage.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Our website may contain links to third-party websites. This Privacy Policy applies only to our website. We are not responsible for the privacy practices of third-party sites. Please review their privacy policies before providing any personal information.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Our website is not intended for individuals under the age of 18. We do not knowingly collect personal information from children. If we become aware that we have collected information from a child, we will take steps to delete such information promptly.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We use cookies and similar tracking technologies to enhance your experience. You can control cookie preferences through your browser settings. Some features of our website may not function properly if you disable cookies.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We retain personal information for as long as necessary to fulfill the purposes outlined in this Privacy Policy, unless a longer retention period is required by law. When information is no longer needed, we securely delete or anonymize it.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              If you are located outside the United States, be aware that information we collect may be transferred to, stored in, and processed in the United States and other countries. By using our website, you consent to the transfer of your information to countries outside your country of residence.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">12. Updates to This Privacy Policy</h2>
            <p>
